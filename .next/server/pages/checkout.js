...
/******/ 			var chunk = require("../" + ({}[chunkId]||chunkId) + "." + {"22":"2afcfe0a9ea3479c7f5b"}[chunkId] + ".js");
...
function Checkout() {
  const CheckoutComponent = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/* import() */ 22).then(__webpack_require__.bind(null, "9jNx")), {
    loadableGenerated: {
      webpack: () => [/*require.resolve*/("9jNx")],
      modules: ["../components/checkout/checkout"]
    }
  });
  return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])(CheckoutComponent, {});
}
