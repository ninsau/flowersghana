...
const footers = [
  {
    title: 'Company',
    description: [{name: 'About', link: '/about'},
  ...
  {
    title: 'Social',
    description: [{name: 'Instagram', link: 'https://instagram.com/flowerghana'},
                  {name: 'Facebook', link: 'https://facebook.com/flowerghana'},
                  {name: 'WhatsApp', link: 'https://api.whatsapp.com/send?phone=233242877574'},
  ...
  },
  {
    ...
    description: [{name: 'Privacy policy', link: '/privacy'},
